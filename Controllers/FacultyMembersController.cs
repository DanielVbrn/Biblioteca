...
namespace Livraria.Controllers
{
    public class FacultyMembersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Mname,Maddress,Mno")] FacultyMember facultyMember)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Mname,Maddress,Mno")] FacultyMember facultyMember)
        {
